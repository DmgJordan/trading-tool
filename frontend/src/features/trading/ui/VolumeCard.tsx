...
import { INDICATOR_CARD_CLASSES, getVolumeSpikeColor } from '@/shared/lib/ui';
...
export default function VolumeCard({
  ...
  return (
    <div
      className={`${INDICATOR_CARD_CLASSES.volume} p-4 rounded-xl border-2 border-gray-300 ${className}`}
    >
      ...
      <div className="text-center">
        <div
          className={`text-lg font-bold ${getVolumeSpikeColor(indicators.spike_ratio)}`}
        >
