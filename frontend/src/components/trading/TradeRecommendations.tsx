...
export default function TradeRecommendations({
  ...
  const getResultSummary = () => {
    ...
    return { successCount, partialCount, errorCount, totalExecuted: executed.length };
  };
    ...
    return (
      <div className={`bg-gray-50 border border-gray-200 rounded-xl p-8 text-center ${className}`}>
        ...
        <p className="text-gray-600 max-w-md mx-auto">
          Claude n'a identifié aucun signal de trading suffisamment fiable selon les critères techniques actuels.
          Cela peut indiquer un marché en consolidation ou l'absence de confluence d'indicateurs.
        </p>
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            💡 <strong>Conseil :</strong> Attendez de meilleurs setups ou analysez d'autres actifs.
          </p>
        </div>
      </div>
    );
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 text-sm mt-1">
            ...
            {' '}générée{recommendations.length > 1 ? 's' : ''} • {formatTimestamp(analysisTimestamp)}
          </p>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-blue-800">
            ...
            <p>
              Ces recommandations sont basées sur l'analyse technique multi-timeframes de Claude.
              Chaque trade inclut une gestion automatique des risques avec stop-loss et take-profits échelonnés.
