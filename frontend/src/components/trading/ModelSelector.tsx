        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1 text-sm text-blue-900">
            ...
            <div className="space-y-1.5 text-blue-800">
              <p>
                <strong className="font-semibold">Haiku 3.5</strong> : Ultra-rapide pour analyses immédiates et résumés concis
              </p>
              <p>
                <strong className="font-semibold">Sonnet 4.5</strong> : Intelligence supérieure pour analyses complexes (recommandé)
              </p>
              <p>
                <strong className="font-semibold">Opus 4.1</strong> : Le plus puissant pour analyses institutionnelles critiques
              </p>
            </div>
          </div>
        </div>
