...
import { INDICATOR_CARD_CLASSES } from '@/utils/ui';
...
export default function MACard({
  ...
  return (
    <div className={`${INDICATOR_CARD_CLASSES.ma} p-4 rounded-xl border-2 border-gray-300 ${className}`}>
      ...
      <div className="space-y-1">
        ...
        <div className="flex justify-between text-sm">
          <span>MA200:</span>
          <span className="font-semibold">{formatNumber(indicators.ma200)}</span>
        </div>
      </div>
    </div>
  );
