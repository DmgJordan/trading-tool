      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start space-x-2">
          ...
          <div className="text-sm text-blue-800">
            ...
            <p>
              <strong>Haiku</strong> : Idéal pour des analyses rapides et des résumés courts.<br />
              <strong>Sonnet</strong> : Équilibre parfait entre qualité et vitesse pour la plupart des cas.<br />
              <strong>Opus</strong> : Analyses les plus détaillées et nuancées, recommandé pour des décisions importantes.
            </p>
          </div>
        </div>
      </div>
