...
import { useCCXTAnalysis } from '@/hooks/useCCXTAnalysis';
...
export default function CCXTTest() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border-2 border-black p-8 sm:p-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select
              ...
              onChange={e =>
                setSelectedProfile(e.target.value as typeof selectedProfile)
              }
              className="w-full p-3 border-2 border-gray-300 rounded-lg focus:border-black focus:outline-none"
            >
      ...
      {/* Bouton d'analyse */}
      <div
        className={`p-6 rounded-xl border-2 transition-all duration-300 ${getStatusColor(status)}`}
      >
        ...
        <div className="mt-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div
                className={`${INDICATOR_CARD_CLASSES.atr} p-4 rounded-xl border-2 border-gray-300`}
              >
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <div
                className={`${INDICATOR_CARD_CLASSES.structure} p-4 rounded-xl border-2 border-gray-300`}
              >
                <div className="text-center">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div
                className={`${INDICATOR_CARD_CLASSES.price} p-4 rounded-xl border-2 border-gray-300`}
              >
                <div className="text-center">
